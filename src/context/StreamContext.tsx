...
const Playlists: React.FC = () => {
  ...
  const { startPlaylistStream } = useStream();
  ...
  const executePlaylistAction = async () => {
    ...
    try {
      switch (selectedAction.type) {
        case 'start':
          // Usar o contexto de stream para iniciar a playlist
        ...
        case 'pause':
        case 'stop':
          // Implementar pausa/parada via contexto
            ...
            {selectedAction.type === 'start' && (
              <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-4">
                <p className="text-sm text-blue-800">
                  <strong>Nota:</strong> A transmissão será iniciada automaticamente. 
